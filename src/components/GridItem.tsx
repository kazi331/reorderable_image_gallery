            ...
            <label style={labelStyle} htmlFor={item.id.toString()}>
                <span className={styles.check}>
                    <span className={styles.checkbg}>
                        <svg xmlns="http://www.w3.org/2000/svg" className={styles.checkmark} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" ><path d="M20 6 9 17l-5-5" /></svg>
                    </span>
                </span>
            </label>
        </div>
